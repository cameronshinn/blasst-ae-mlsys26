...
> [!IMPORTANT]
> If you use a cloud provider that launches an instance directly from a Docker image, you can point it to [nvcr.io/nvidia/tensorrt-llm/release:1.3.0rc3](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/tensorrt-llm/containers/release?version=1.3.0rc3).
